...
<div class="columns is-mobile is-vcentered"  style="background-color: #e01c1c66;" >
<div class="column"
...
const todosCollectionRef = collection(db, 'AdminXmassive')
...
.borderEvent {
border-bottom: 4px solid #e01c1c;
}  
.logo{
color: #111010;
}
