...
<div class=" justify-center md:flex gap-10">
  ...
  >
        <img class="event_logo justify-center items-center	" src="../assets/Cap.webp" 
...
<div>
  ...
  <div>
<div class="max-w-sm p-6 mx-8 mb-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
  <a href="#"
  class="justify-center items-center	"
  >
        <img class="event_logo justify-center items-center	" src="../assets/Cap.webp" 
