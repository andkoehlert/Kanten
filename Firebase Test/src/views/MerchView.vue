...
<div class="flex justify-center mt-10 mb-10 lg:justify-start lg:mt-6 lg:ms-20">
<div class="flex-none ...">
...
class="justify-center items-center  "
>
  <img class="object-contain h-60 w-96  event_logo justify-center items-center  " src="../assets/manaclubKantenMerch.png"
